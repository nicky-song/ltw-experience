...
const trueFalseProps = {
  ...multipleChoicePropsLearner,
  block: trueFalseBlock,
};

describe('multiple choice block quiz card tests', () => {
  it('should render a a question and a list of answers for admin quiz card', () => {
    render(
  ...
  it('should render a question and a radio list of answers for learner quiz', () => {
    render(
      <QueryClientProvider client={queryClient}>
  ...
  it('should select incorrect option for selectall learner quiz with confidence check', () => {
    render(
      <QueryClientProvider client={queryClient}>
    ...
    expect(screen.getByTestId('confidence-card-container')).toBeInTheDocument();
    fireEvent.click(screen.getByTestId('confidence-level-50'));
  ...
  it('should select correct option for selectall learner quiz with confidence check', () => {
    render(
      <QueryClientProvider client={queryClient}>
        <SelectOptionBlock {...multipleChoicePropsLearnerSelectAll} />
      </QueryClientProvider>,
    ...
    fireEvent.click(screen.getByTestId('confidence-level-100'));
    expect(screen.getByTestId('knowledge-check-button')).toBeInTheDocument();
    fireEvent.click(screen.getByTestId('knowledge-check-button'));
