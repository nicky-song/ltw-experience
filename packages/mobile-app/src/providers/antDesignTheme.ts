// This file is originally copied from https://github.com/ant-design/ant-design-mobile-rn/blob/5.0.4/components/style/themes/default.tsx
const overrides = {
  colorPrimary: '#000000',
  colorPrimaryHover: '#6FC07A',
  colorPrimaryBg: 'rgba(0, 0, 0, 0.05)',
  colorBgTextHover: '#f6ffed',
};

const brandPrimary = overrides.colorPrimary;

const brandPrimaryTap = overrides.colorPrimaryHover;
...
export const theme = {
  ...
  primary_button_fill_tap: overrides.colorPrimaryHover,
